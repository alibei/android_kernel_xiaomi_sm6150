...
#define SC8551_VBAT_ADC_LSB				((12500000 / 10000000) * (10044000 / 10000000))
#define SC8551_VBAT_ADC_LSB_NON_CALIBRATE		(12500000 / 10000000)
#define SC8551_IBAT_ADC_LSB				(31250000 / 10000000)
#define SC8551_TSBUS_ADC_LSB				(10000000 / 10000000)
#define SC8551_TSBAT_ADC_LSB				(10000000 / 10000000)
#define SC8551_TDIE_ADC_LSB				(10000000 / 10000000)
